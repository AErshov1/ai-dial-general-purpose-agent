...
class FileContentExtractionTool(BaseTool):
    ...
    def description(self) -> str:
        return """
            This tool extracts text content from files. Supported: PDF (text only), TXT, CSV (as markdown table), HTML/HTM.
            PAGINATION: Files >10,000 chars are paginated. Response format: `**Page #X. Total pages: Y**` appears at end if paginated.
            """
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        ...
        if not content:
            content = "Error: File content not found or extraction failed"
        ...
        if len(content) > page_size:
            ...
            if page < 1:
                ...
                return f"Error: Page {page} doesn't exist. Total Page: {total_pages}"
